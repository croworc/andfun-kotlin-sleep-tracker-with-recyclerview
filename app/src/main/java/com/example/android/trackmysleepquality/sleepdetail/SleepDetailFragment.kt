...
class SleepDetailFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        // Retrieve the fragment arguments: contains the SleepNight ID (as type `Long`).
        val arguments = SleepDetailFragmentArgs.fromBundle(requireArguments())

        // Get a reference to the singleton instance of the database.
        val application = requireNotNull(this.activity).application
        val dataSource = SleepDatabase.getInstance(application).sleepDatabaseDao

        // Create an instance of the ViewModel Factory. Pass the sleep night ID and the db-ref.
